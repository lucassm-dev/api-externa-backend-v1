...
## T-409 — Migrar adapters de cotação (Brapi/TwelveData) para IntegracaoExternaException tipada (EXT-008/009/010) [concluida]
- Refs: AC-429, AC-430
...
## T-410 — Migrar catálogo de Corretora (COR-001/002/003) e separar CVM indisponível de CVM não autorizada (EXT-007) [concluida]
- Refs: AC-433, AC-434
