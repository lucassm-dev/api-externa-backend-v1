...
## T-470 — Migração V16: unicidade parcial de e-mail e CPF [concluida]
...
## T-471 — Entidade Investidor sem unique incondicional [concluida]
- Refs: AC-505, AC-506
...
## T-472 — Repositório: consultas de investidor filtrando ativo [concluida]
...
## T-477 — Testes de resource: 404 e 401 do investidor inativo [concluida]
- Refs: AC-503, AC-504
...
## T-479 — Guarda de arquitetura contra consulta por chave natural sem filtro [concluida]

- Refs: AC-509
- Arquivos: src/test/java/com/apiexternabackend/repositories/ConsultaPorChaveNaturalTest.java
- Notas: teste por reflexão sobre os 6 repositórios; verificado que falha de verdade ao reintroduzir `findByTicker`.

## T-478 — Atualizar catálogo de erros e mapeamento vivo [concluida]
- Refs: AC-503, AC-504, AC-505, AC-506, AC-507, AC-508, AC-509
