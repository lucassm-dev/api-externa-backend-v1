...
## T-429 — Migração V14: campos de lucro realizado e soft delete em Operacao [concluida]
- Refs: AC-469, AC-472
...
## T-430 — Entidade Operacao + repositório com filtro por ativo [concluida]
...
## T-431 — OperacaoService: soft delete e busca filtrando inativas [concluida]
- Refs: AC-472, AC-473
- Arquivos: src/main/java/com/apiexternabackend/services/OperacaoService.java

## T-432 — PosicaoService.recalcular: recompõe lucro realizado a partir do histórico ativo [concluida]
...
## T-433 — Consulta de lucro realizado por carteira e por ticker [concluida]
- Refs: AC-470, AC-471
...
## T-434 — Endpoint GET /carteiras/{id}/lucro-realizado [concluida]
- Refs: AC-470, AC-471
- Arquivos: src/main/java/com/apiexternabackend/resources/OperacaoResource.java

## T-435 — Expor precoMedioCompraNoMomento e lucroRealizado na resposta da operação [concluida]
- Refs: AC-469
...
## T-436 — Testes de serviço: lucro realizado, soft delete e recálculo em cascata [concluida]
...
## T-437 — Testes de resource: endpoint de lucro realizado e 404 em operação excluída [concluida]
- Refs: AC-470, AC-471, AC-473
- Arquivos: src/test/java/com/apiexternabackend/resources/OperacaoResourceTest.java

## T-438 — Atualizar catálogo de erros e mapeamento vivo [concluida]
- Refs: AC-469, AC-470, AC-471, AC-472, AC-473, AC-474, AC-475, AC-476
